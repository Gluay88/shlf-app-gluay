      ...
      <div className="container py-5">
        <div className="row">
          ...
          <div className="About">
            ...
            <br></br>
            <h3 className="text">
              I believe you must bring your whole self to the table if you want
              to thrive in today’s crazy world; your personality, your sense of
              humor, and most importantly, your heart. All of these elements
              brought me to found Shlf back in 2000. Since then, the blog has
              been thriving and has quickly gained a loyal following. I invite
              you to explore my site, learn about my passions, and explore what
